...
<head>
	<meta charset="utf-8" />
	<title>GSL | Top Trending Games</title>
                            ...
                            <div class="col-md-12">
                                <nav aria-label="breadcrumb" class="float-right mt-1">
                                    <ol class="breadcrumb">
                                        ...
                                        <li class="breadcrumb-item active" aria-current="page">Top Trending Games</li>
                                    </ol>
                                </nav>
                                <h4 class="mb-1 mt-0">Top Trending Games</h4>
                            </div>
                        </div>
                            ...
                            <div class="col-12">
                                <div class="card">
                                    <div class="card-body">
                                       <div class="row">
											<div class="col-8">
												<h4 class="header-title mt-0 mb-1">All Top Trending Games List</h4>
											</div>
											<div class="col-4 text-right">
												<button type="button" class="btn btn-primary btn-rounded" data-toggle="modal" data-target="#addGame">Add Top Trending Game</button>
											</div>  
										</div>
                                        ...
                                        <table id="myDataTable" class="table dt-responsive nowrap">
											...
											<?php foreach($list as $row){  ?>
                                                <tr>
													...
													<td class="text-center">
														<a class="text-danger" href="<?php echo site_url('admin/removeTopGame/'.base64_encode($row['gid'])); ?>" onClick="return confirm('Are you sure to remove this game from top trending section?');" ><i data-feather="trash-2" width="24" height="24"></i></a>
													</td>
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="exampleModalLabel">Add Game to Top Trending Section</h5>
        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
          <span aria-hidden="true">&times;</span>
        </button>
      </div>
      <div class="modal-body">
        <form action="<?php echo site_url('admin/saveTopGame') ?>" method="post">
