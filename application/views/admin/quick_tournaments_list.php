...
<head>
	<meta charset="utf-8" />
	<title>GSL | Quick Tournaments</title>
                            ...
                            <div class="col-md-12">
                                <nav aria-label="breadcrumb" class="float-right mt-1">
                                    <ol class="breadcrumb">
                                        ...
                                        <li class="breadcrumb-item active" aria-current="page">Quick Tournaments Games</li>
                                    </ol>
                                </nav>
                                <h4 class="mb-1 mt-0">Quick Tournaments Games</h4>
                            </div>
                        </div>
                            ...
                            <div class="col-12">
                                <div class="card">
                                    <div class="card-body">
                                       <div class="row">
											<div class="col-8">
												<h4 class="header-title mt-0 mb-1">All Quick Tournaments Games List</h4>
											</div>
                                        ...
                                        <table id="myDataTable" class="table dt-responsive nowrap">
											...
											<?php foreach($list as $row){  ?>
                                                <tr>
													...
													<td class="text-center">
														<a class="text-danger" href="<?php echo site_url('admin/removeQuickTournamentGame/'.base64_encode($row['quick_tid'])); ?>" onClick="return confirm('Are you sure to remove this game from quick tournaments section?');" ><i data-feather="trash-2" width="24" height="24"></i></a>
													</td>
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="exampleModalLabel">Add Game to Quick Tournament Section</h5>
        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
          <span aria-hidden="true">&times;</span>
        </button>
      </div>
      <div class="modal-body">
        <form role="form"  class="parsley-examples" action="<?php echo site_url('admin/saveQuickTournamentGame') ?>" method="post">
