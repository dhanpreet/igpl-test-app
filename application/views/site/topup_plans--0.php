						...
						<div class="col-8 col-xs-8 col-sm-8 col-md-8 col-lg-8 text-left light-side">
							...
							<div class="row">
								<div class="col-6 col-xs-6 col-sm-6 col-md-6 col-lg-6">
									<p><b><?php echo $planRow['p_no_of_coins']; ?></b> <br>Play Coins</p>
								</div>
								<!-- <div class="col-6 col-xs-6 col-sm-6 col-md-6 col-lg-6">
							...
							<br>
							<p><a href="<?php echo site_url('TopUpRequest/'.base64_encode($planRow['p_plan'])) ?>" class="btn-filled">Buy now</a></p>
						</div>
