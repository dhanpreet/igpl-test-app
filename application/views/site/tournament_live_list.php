	...
	<div class="row"> <br><br> </div>
		...
		<div class="container">
			<div class="row" style="padding: 0 !important;">
				...
				<?php foreach($payAndPlayTournaments as $stRow){ ?>
					<?php if($stRow['c_country_code']== $this->session->userdata('country_code')) { ?> 
						<div class="col-xs-12" style="padding: 0 !important;">
									...
									<a href="<?php echo site_url('LiveTournament/'.base64_encode($stRow['tournament_id'])) ?>" aria-hidden="false">
										...
										<div class="fee-ticker">Entry <img src="<?php echo base_url() ?>assets/frontend/img/coin.png" style="width:18px; display:inline; margin-top:-3px;"> <?php echo $stRow['fee_tournament_fee']; ?> Coins </div>
										
											

										<div class="row" style="width:98%; margin:0 auto; text-align:center;">
											<h5 class=" btn btn-outline-green text-center" style="width:inherit !important;">WIN <?php echo $stRow['c_country_code']; ?><img src="<?php echo base_url() ?>assets/frontend/img/gold-coin.png" style="width:18px; display:inline; margin-top:-3px;"> <span style="font-size:1em;"><b><?php echo $stRow['fee_tournament_prize_1']; ?></b></span></h5>
										</div>												
											<br><br>
									</a>
...
<?php  if($this->freeTournamentEnabled == 1 && is_array($freeTournaments) && count(@$freeTournaments)>0 ){ ?>
		...
		<?php 
			if($freeRow['c_country_code']== $this->session->userdata('country_code')) { ?>
    <div class="col-xs-6" style="padding: 7px !important;">
     
			<div  class="small-tournaments-slider slider">
					...
					<a href="<?php echo site_url('LiveTournament/'.base64_encode($freeRow['tournament_id'])) ?>" aria-hidden="false">
						...
						<div data-countdown="<?php echo date('Y/m/d', strtotime($freeRow['tournament_end_date'])) ?> <?php echo $freeRow['tournament_end_time'].":00"; ?>" class="time-ticker" id="st-timer-<?php echo $freeRow['tournament_id']; ?>"> </div>
...
<div class="modal fade" id="less_play_coins" role="dialog">
 ...
 <!--  <div class="modal fade modal_custom" id="terms_and_conditions" tabindex="-1" role="dialog" aria-labelledby="example" aria-hidden="true">
		<div class="modal-dialog" role="document">
			<div class="modal-content">
			<div class="modal-header">
        <h3 class="modal-title" id="exampleModalLabel">How to renew</h3>
        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
          <span aria-hidden="true">&times;</span>
			...
			<div class="modal-body">
				<ul>
					<li>Please maintain sufficient balance into your bkash account.</li>
					<li>Auto payment will be done on renewal date.</li>
					<li>If auto payment fails due to insufficient balance/account status, then we will cancel your Subscription.</li>
					<li>You can re-subscribe as many times as you want.</li>
				</ul>
			</div>
