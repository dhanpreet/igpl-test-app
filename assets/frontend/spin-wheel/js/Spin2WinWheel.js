function Spin2WinWheel() {
	...
	var soundAudioPath = soundAudioPath= window.location.origin+"/GPL-PT/assets/frontend/spin-wheel/media/wheel_tick.mp3";
  ...
  var xmlns = "http://www.w3.org/2000/svg",
    ...
    spinVelocityTracker,
    gameResultsArray = [],
    pegSnd = new Audio(soundAudioPath),
    ...
    showResult = function(e) {
      ...
      if (!isNaN(e)) {
        ...
        //create a result object 
        resultObj = {target:thisWheel, type:'result', id:segmentValuesArray[e].id, spinCount:spinCount, win:segmentValuesArray[e].win, msg:segmentValuesArray[e].resultText, gameId:gameId};
